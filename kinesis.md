...
It's not [Storm](http://storm-project.net/), nor [Samza](http://samza.incubator.apache.org/) as it has been mentioned, so it's not really "fully managed" realtime "processing".
